...
use crate::{types::{enums::Webservice, errors::ErrType}, wsaa::auth_arca::auth_arca};
...
pub async fn get_token(
	...
	let CertKeyPair {cuit, cert_contents, key_contents} = cert_key_getter();
