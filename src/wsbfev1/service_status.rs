...
use crate::{
    types::FEDummyResult,
    wsbfev1::url::{WSBFEV1_URL_HOMO, WSBFEV1_URL_PROD},
...
pub async fn service_status(
    ...
    let send_xml = r#"<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ar="http://ar.gov.afip.dif.bfev1/">
   <soapenv:Header/>
   <soapenv:Body>
      <ar:BFEDummy/>
   </soapenv:Body>
