...
use crate::{
    types::FEDummyResult,
    ws_sr_constancia_inscripcion::url::{
        WS_SR_CONSTANCIA_INSCRIPCION_URL_HOMO, WS_SR_CONSTANCIA_INSCRIPCION_URL_PROD,
    },
...
pub async fn service_status(
    ...
    let send_xml = r#"<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:a5="http://a5.soap.ws.server.puc.sr/">
   <soapenv:Header/>
   <soapenv:Body>
      <a5:dummy/>
   </soapenv:Body>
