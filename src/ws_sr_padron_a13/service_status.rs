...
use crate::{
    types::FEDummyResult,
    ws_sr_padron_a13::url::{WS_SR_PADRON_A13_URL_HOMO, WS_SR_PADRON_A13_URL_PROD},
...
pub async fn service_status(
    ...
    let send_xml = r#"<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:a13="http://a13.soap.ws.server.puc.sr/">
   <soapenv:Header/>
   <soapenv:Body>
      <a13:dummy/>
   </soapenv:Body>
